<template>
    <Modal @close="closeModal" :show="show" :max-width="'md'">
        <form class="flex flex-col w-full" @submit.prevent="submit">
            ...
            <span class="font-sans text-lg font-semibold text-[#F5F5F6] mt-4">Create Group</span>
            <span class="font-sans text-sm text-[#94969C]">Add a new group to organize your categories</span>
    ...
    form.post(`/settings/groups`, {
        ...
        onSuccess: () => {
            ...
            notifyBus.emit('notify', {
                title: 'Group Added',
                body: 'Group has been added successfully.',
                type: 'success'
            });
        }
    })
