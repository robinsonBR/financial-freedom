<template>
    ...
    <div class="w-full flex flex-col">
        ...
        <div class="flex items-center justify-between py-5">
            ...
            <button @click="addGroup" class="bg-[#155EEF] text-[#F5F5F6] font-sans text-sm font-semibold py-[10px] px-[14px] rounded-lg flex items-center">
